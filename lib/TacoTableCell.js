...
var TacoTableCell = function (_React$Component) {
  ...
  function TacoTableCell(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TacoTableCell).call(this, props));
  ...
  _createClass(TacoTableCell, [{
    ...
    value: function computeWithPlugins(property, cellData) {
      ...
      var highlightedRow = _props2.highlightedRow;
      var columnSummary = _props2.columnSummary;
      ...
      function getValue(maybeFunction) {
        if (typeof maybeFunction === 'function') {
          return maybeFunction(cellData, columnSummary, column, rowData, highlightedColumn, highlightedRow, rowNumber, tableData, columns);
        }
    ...
    value: function render() {
      ...
      var cellData = (0, _Utils.getCellData)(column, rowData, rowNumber, tableData, columns);

      var rendered = (0, _Utils.renderCell)(cellData, column, rowData, rowNumber, tableData, columns);
