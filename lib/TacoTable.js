...
var propTypes = {
  bottomData: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.array, _react2.default.PropTypes.object, _react2.default.PropTypes.bool]),
    ...
    value: function renderBottomData() {
      ...
      var computeRowData = (0, _lodash2.default)(function (bottomRowIndex, computedRowData, column, columnIndex) {
        ...
        if (computedRowData[column.id] != null && bottomDataRender == null) {
          computedRowData[column.id] = (0, _Utils.renderCell)(computedRowData[column.id], column, computedRowData, 'bottom-' + bottomRowIndex, data, columns, false);
